...
export default function LogoSocialMedia() {
  return (
    <>
      <p className={scss.logo}>snehasisDebbarman</p>
      <div className={scss.social_media}>
        ...
        >
          ...
          >
            ...
            <path
    fill="currentColor"
    d="M50 0C22.386 0 0 22.386 0 50C0 77.614 22.386 100 50 100C77.614 100 100 77.614 100 50C100 22.386 77.614 0 50 0ZM50 20C63.254 20 74 30.746 74 44V56C74 69.254 63.254 80 50 80H30V20H50ZM50 60C55.522 60 60 55.522 60 50C60 44.478 55.522 40 50 40C44.478 40 40 44.478 40 50C40 55.522 44.478 60 50 60Z"
  />
  </svg>
        </a>
      </div>
